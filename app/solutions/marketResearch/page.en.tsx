...
const ACTIVE_RESEARCH_KEY = "marketResearch:activeResearch:en";
...
export default function MarketResearchPage() {
  ...
  const getMissingRequiredFields = (): { key: string; label: string }[] => {
    ...
    if (!formData.productName.trim()) missing.push({ key: "productName", label: "Product or service name" });
    if (!formData.productDescription.trim()) missing.push({ key: "productDescription", label: "Description" });
    if (!formData.country) missing.push({ key: "country", label: "Country" });
    if (formData.businessTypes.length === 0) missing.push({ key: "businessTypes", label: "Business type" });
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={styles.section}>
                ...
                <div className={styles.formGroup}>
                  ...
                  {submitAttempted && !formData.productName.trim() && (
                    <span style={fieldErrorTextStyle}>Required field</span>
                  )}
                </div>
              ...
              <div className={styles.section}>
                ...
                {submitAttempted && formData.businessTypes.length === 0 && (
                  <span style={fieldErrorTextStyle}>Select at least one option</span>
                )}
              </div>
              ...
              <div className={styles.section}>
                ...
                {submitAttempted && !formData.localization && (
                  <span style={fieldErrorTextStyle}>Select an option</span>
                )}
              </div>
                ...
                <div className={styles.section}>
                  ...
                  {submitAttempted && !privacyAccepted && (
                    <span style={fieldErrorTextStyle}>
                      Consent is required to start the research
                    </span>
                  )}
                </div>
              )}
