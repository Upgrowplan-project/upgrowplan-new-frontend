  ...
  return (
    <div className="blog-page d-flex flex-column min-vh-100">
      ...
      <main className="blog-page py-5">
        <h1 className="text-brand mb-4">Blog</h1>

        <p
          className="mt-3 mb-5 lead"
          style={{ maxWidth: "800px", lineHeight: "1.7", fontSize: "1.125rem" }}
        >
          Hi 👋 — here we share practical experience: business ideas, case
          studies, checklists, analytics and insights. Want to stay updated?
          Follow us:
        </p>
        ...
        {posts.length === 0 ? (
          <p className="release-soon">No posts yet 😄</p>
        ) : (
