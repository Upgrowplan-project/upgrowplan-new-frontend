...
export default function Home() {
  ...
  const logLines = useMemo(
    () => [
      ...
      {
        text: "[Agent: Fin Pilot] Финмодель (CapEx/OpEx)... Завершено",
        speed: 24,
      },
      {
  ...
  const personas = [
    {
      ...
      dialog: [
        {
          speaker: "skeptic",
          text: "Добрый день, Петр Петрович. Планируем открыть крафтовый пивбар в вашем доме. Цены — премиум, атмосфера — тихий лофт. Как вам идея? 🍻",
          time: "10:02",
        },
        {
          speaker: "avatar",
        ...
        {
          speaker: "avatar",
          text: "Тишина после 22:00? До этого вы все так обещаете. А потом будут орать под окнами. И вообще, пиво за 300... я лучше дочке на подарок добавлю. Не пойду я к вам. 😕",
          time: "10:05",
          status: "Прочитано ✓✓",
        },
        {
          speaker: "skeptic",
          text: "[RAG Validation]: Гипотеза не подтверждена. Низкий интерес целевой аудитории (пенсионеры) из-за цены и страха шума. Рекомендуем пересмотреть район.",
          time: "10:06",
        },
      ],
    },
    {
      name: "Оксана",
      age: 28,
      role: "Офисный профессионал",
      income: "120–150k руб/мес",
      preferences: ["Эстетика", "Время", "Статус", "Технологии"],
      data: "Основано на 1.1k офисных опросах",
      caseTitle: "Семейная кондитерская у офиса",
      image: "/images/personas/lina.jpg",
      dialog: [
        {
          speaker: "skeptic",
          text: "Оксана, привет. Открываем семейную кондитерскую рядом с вашим офисом. Детские праздники, ростовые куклы, торты под заказ. Будете заходить? 🍰",
          time: "11:10",
        },
        {
          speaker: "avatar",
        ...
        {
          speaker: "skeptic",
          text: "[RAG Validation]: Гипотеза подтверждена на 50%. Интерес есть к продукту (эстетика/кофе), но концепция «семейной» кондитерской отпугивает платежеспособную аудиторию без детей.",
          time: "11:14",
        },
      ],
    },
    {
      ...
      dialog: [
        {
          speaker: "skeptic",
          text: "Мария, добрый день. Планируем сервис шеринга дорогих инструментов: перфораторы, тепловизоры. Как вы, как предприниматель, оцениваете идею? 🛠",
          time: "12:20",
        },
        {
          speaker: "avatar",
        ...
        {
          speaker: "skeptic",
          text: "[RAG Validation]: Гипотеза не подтверждена. Высокие операционные расходы и риски (логистика/ремонт) убивают юнит-экономику для этой целевой аудитории.",
          time: "12:24",
        },
      ],
    },
    {
      name: "Никита",
      age: 21,
      role: "Студент-мечтатель",
      income: "15–20k руб/мес",
      preferences: ["Тренды", "Хайп", "Экология", "Сообщество"],
      data: "Основано на 900 интервью со студентами",
      caseTitle: "Школа каллиграфии онлайн",
      image: "/images/personas/student.jpg",
      dialog: [
        {
          speaker: "skeptic",
          text: "Никита, привет. Тестируем идею онлайн-школы каллиграфии. Это успокаивает, развивает мозг и сейчас в тренде на экологичность. Запишешься на курс? ✍️",
          time: "13:05",
        },
        {
          speaker: "avatar",
        ...
        {
          speaker: "skeptic",
          text: "Это позволяет разгрузить мозг от гаджетов. Сообщество, оффлайн встречи.",
          time: "13:07",
        },
        {
          speaker: "avatar",
        ...
        {
          speaker: "skeptic",
          text: "[RAG Validation]: Гипотеза не подтверждена. Целевая аудитория (студенты) ценит скорость и практичный результат, а не «медленные» хайпы. Тренд экологичности не работает в этом контексте.",
          time: "13:09",
        },
      ],
    },
    {
      ...
      role: "Директор",
      income: "400k+ руб/мес",
      preferences: ["Риски", "Масштаб", "Финмодель", "Стратегия"],
      data: "Основано на 420 интервью с директорами",
      caseTitle: "Франшиза автомоек «Антигрязь»",
      image: "/images/personas/director.jpg",
      dialog: [
        {
          speaker: "skeptic",
          text: "Виктор Борисович, добрый день. Рассматриваем покупку франшизы автоматических моек. Качество среднее, но скорость (3 минуты) и низкая маржа. Что скажете? 🚗💨",
          time: "14:30",
        },
        {
          speaker: "avatar",
        ...
        {
          speaker: "skeptic",
          text: "[RAG Validation]: Гипотеза не подтверждена. Опытный инвестор считает финансовую модель слишком оптимистичной, а рыночную конкуренцию в Москве — фатальной.",
          time: "14:34",
        },
      ],
    },
    {
      ...
      preferences: ["Удобство", "Время", "Дети", "Лояльность"],
      data: "Основано на 1.5k домашних опросах",
      caseTitle: "Подписка на уборку «Чистый Понедельник»",
      image: "/images/personas/homemaker.jpg",
      dialog: [
        {
          speaker: "skeptic",
          text: "Елена, здравствуйте. Открываем сервис регулярной уборки квартир по подписке. 2 раза в месяц, фиксированная цена, те же клинеры. Будете пользоваться? 🧹✨",
          time: "15:40",
        },
        {
          speaker: "avatar",
        ...
        {
          speaker: "skeptic",
          text: "[RAG Validation]: Гипотеза подтверждена. Сервис закрывает боли целевой аудитории (домохозяйки) по времени и доверию при приемлемой цене. Высокий виральный потенциал.",
          time: "15:44",
        },
      ],
    },
  ...
  useEffect(() => {
    ...
    const animate = (time: number) => {
      ...
      setVatRate(Math.round(20 * progress));
        ...
        <section className="hero-2026">
          <div className="container hero-grid">
            <div className="hero-copy">
              <h1>Проверь идею. Посчитай экономику. Покажи инвестору.</h1>
              <p className="hero-subtitle">
                Бизнес-план по стандартам UNIDO/EBRD с реальными данными рынка — за 10–20 минут.
                Синтетические респонденты выявят реальные боли рынка. Skeptic Agent проверит каждую цифру.
                <br />
                <strong>Результат:</strong> бизнес-план в формате Word + питч-презентация для инвестора или банка.
              </p>
        ...
        <section className="rag-proof section-pad">
          <div className="container rag-grid">
            <div className="rag-copy">
              <h2>
                Upgrowplan создаёт и проверяет бизнес-планы на живых данных.
                <span className="accent-inline">
                  {" "}
                  Это не генератор текста, а пошаговая валидация каждого факта.
                </span>
              </h2>
        ...
        >
          <div className="container">
            <div className="proof-head">
              <h2>
                Каждая цифра в вашем бизнес-плане или маркетинговом отчёте имеет автора.
                <span className="accent-inline">
                  {" "}
                  Прямые ссылки на конкурентов, объявления рынка труда,
                  предложения сырья и оборудования, налоговый кодекс 2026 года.
                </span>
              </h2>
            </div>
            <div className="proof-grid">
              <div className="proof-note">
                ...
                <p className="micro-copy">
                  Мы используем RAG (Retrieval-Augmented Generation), это
                  генерация с расширенными возможностями поиска. ИИ сначала
                  находит актуальные документы, проверяет актуальность для
                  вашего кейса и только затем использует их для создания бизнес
              ...
              <div className="report-card">
                <div className="report-title">Реальные источники данных</div>
                <p className="micro-copy">
                  Ставка НДС (Франция, 2026):
                  <span
                    className="source-ref"
                    onClick={() => toggleSource(0)}
                    role="button"
                    tabIndex={0}
                    onKeyDown={(e) => e.key === "Enter" && toggleSource(0)}
                  >
                    ...
                    <span className="source-rate">{vatRate}% [1]</span>
                    <span
                      className={`source-card${openSources.has(0) ? " open" : ""}`}
                    >
                      <span className="source-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" className="icon-svg">
                          <path
                ...
                <p className="micro-copy">
                  Объем рынка (coffee subscriptions):
                  <span
                    className="source-ref"
                    onClick={() => toggleSource(1)}
                    role="button"
                    tabIndex={0}
                    onKeyDown={(e) => e.key === "Enter" && toggleSource(1)}
                  >
                    <span className="source-icon-inline" aria-hidden="true">
                      <svg viewBox="0 0 24 24" className="icon-svg">
                        <path
                    ...
                    <span className="source-rate">${marketSize}B [2]</span>
                    <span
                      className={`source-card${openSources.has(1) ? " open" : ""}`}
                    >
                      <span className="source-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" className="icon-svg">
                          <path
                ...
                <p className="micro-copy">
                  ...
                  <span
                    ...
                    role="button"
                    tabIndex={0}
                    onKeyDown={(e) => e.key === "Enter" && toggleSource(2)}
                  >
                    <span className="source-icon-inline" aria-hidden="true">
                      <svg viewBox="0 0 24 24" className="icon-svg">
                        <path
                    ...
                    <span className="source-rate">{growthRate}% [3]</span>
                    <span
                      className={`source-card${openSources.has(2) ? " open" : ""}`}
                    >
                      <span className="source-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" className="icon-svg">
                          <path
        ...
        <section className="skeptic-block section-pad" ref={skepticRef}>
          <div className="container skeptic-grid">
            <div className="skeptic-copy">
              <h2>
                Наш Агент-Скептик проверит идею на прочность, найдёт скрытые расходы, укажет на риски перенасыщенного рынка.
                <span className="accent-inline">
                  {" "}
                  Upgrowplan честен по отношению к клиентам — лучше предупредить о возможном убытке, чем создать иллюзию прибылей.
                </span>
              </h2>
              <p className="micro-copy">
            ...
            <div className="skeptic-widget">
              ...
              <div className="red-flags">
                <details>
                  <summary>[!] Риск: Конкуренция</summary>
        ...
        <section className="persona-block section-pad">
          <div className="container persona-grid">
            <div className="persona-copy">
              <h2>
                Мы создаём ваших виртуальных покупателей и проверяем вашу гипотезу.
                <span className="accent-inline">
                  {" "}
                  Теперь можно спросить тех, кто действительно купит или скажет, почему это не интересно.
                </span>
              </h2>
              <p className="micro-copy">
                ...
                <div className="chat-header">
                  <div>
                    <div className="chat-case">
                      Кейс: {activePersonaData?.caseTitle}
                    </div>
        ...
        <section className="anti-template section-pad">
          <div className="container">
            <div className="anti-title-row">
              <h2>
                Мы полностью отказались от шаблонов.
                <span className="accent-inline">
                  {" "}
                  Каждое слово в вашем бизнес-плане рождается в момент запроса. Мы проектируем ваш бизнес на живых данных вашего города, улицы и ниши.
                </span>
              </h2>
            </div>
            <div className="row align-items-center gy-4">
                  ...
                  >
                    <div className="layer-upgrow">
                      <div className="upgrow-fixed">
                        ...
                        <h4>Стратегия: Haifa, Hadar District | April 2026</h4>
                        <p>
              ...
              <div className="col-lg-4 ps-lg-5">
                <p className="micro-copy">
                  Upgrowplan не играет заготовками. Они дают ложное чувство безопасности, используя цифры, которые не имеют отношения к вашему бизнесу.
                </p>
                <ul>
                  <li>
                    Живой поиск: наши агенты «ногами» обходят улицы вашего города или сайты прямых конкурентов.
                  </li>
                  <li>
                    Никакой воды: мы пишем про цены у вашего соседа справа.
                  </li>
                  <li>
                    Проверка гипотез: данные сверяются с трендами и бенчмарками этого месяца.
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div className="row align-items-center gy-4">
                  <div className="col-lg-5 text-center">
                    <h2 className="deep-title">
                      Наш бизнес-план не создаётся за 30 секунд.
                      <span className="accent-inline">
                        {" "}
                        Чтобы собрать и проверить данные, сформировать и опросить виртуальных покупателей и проверить факты скептиком — нам нужно 10–15 минут.
                      </span>
                    </h2>
                  </div>
