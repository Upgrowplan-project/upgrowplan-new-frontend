        ...
        <section className="hero-2026">
          <div className="container hero-grid">
            <div className="hero-copy">
              <h1>
                Реальный мир не работает по шаблонам. Ваш план тоже не должен.
              </h1>
          ...
          <div className="container">
            <div className="proof-head">
              <h2>
                ...
                <span className="accent-inline">
                  {" "}
                  Прямые ссылки на ваших конкурентов, обьявления рынка труда,
                  предложения сырья и оборудования и налоговый кодекс 2026 года.
                </span>
              </h2>
            </div>
        ...
        <section className="skeptic-block section-pad" ref={skepticRef}>
          <div className="container skeptic-grid">
            <div className="skeptic-copy">
              <h2>
                Единственный ИИ, который не боится сказать вам «нет».
                <span className="accent-inline">
                  {" "}
