...
const LIVE_METRICS = [
  { label: "Average ticket", value: "$48", trend: "+3%" },
  { label: "Market share", value: "18.4%", trend: "+1.2 pp" },
  { label: "Competitive pressure", value: "Moderate", trend: "↓" },
  { label: "Top trend", value: "Nitro coffee", trend: "↑ 22%" },
];
        ...
        <div className="bp-hero-row" style={{ display: "flex", alignItems: "center", gap: 64, flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 360px" }}>
            ...
            <h1 className="bp-hero-title">
              ...
              <span className="bp-hero-accent">Just start using it.</span>
            </h1>
            <p style={{ color: "#64748b", fontSize: 17, lineHeight: 1.75, marginBottom: 36 }}>
              Everyone says you must implement AI. We did it — carefully. You don’t need to let unknown agents into
              your accounting system, grant access to sensitive data, or export commercial information to external tools.
              You tell us what you do and where, and we deliver weekly market monitoring and regulatory updates.
            </p>
...
const MOCK_MARKERS = [
  { lng: 0.005, lat: 0.004, type: "red", label: "Competitor cut prices by 15%" },
  { lng: -0.006, lat: 0.007, type: "yellow", label: "New 5‑star review for a competitor" },
  { lng: 0.008, lat: -0.005, type: "green", label: "Trend: delivery demand ↑ 28%" },
  { lng: -0.004, lat: -0.008, type: "red", label: "Competitor promo: -20% until Friday" },
  { lng: 0.010, lat: 0.003, type: "green", label: "New niche with no nearby rivals" },
];
  ...
  const handleAddressLookup = useCallback(async () => {
    ...
    try {
      const res = await fetch(
        `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(address)}.json?limit=1&language=en&access_token=${token}`
      );
      ...
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <h2 style={{ fontSize: "clamp(1.6rem,3vw,2.3rem)" }}>
            Growth territory: your location at a glance.
            <span style={{ color: "#0683f5" }}>
              {" "}
              The map shows real competitor activity, demand, and weak spots around your location.
            </span>
          </h2>
        </div>
             ...
             <div style={{
              ...
              {status === "loading" ? (
                <>
                  ...
                  <p style={{ color: "#64748b", fontSize: 15 }}>Detecting location…</p>
                </>
              ) : (
                <>
                  ...
                  <p style={{ color: "#94a3b8", fontSize: 13 }}>
                    Click “Show my area” to launch the map
                  </p>
                </>
              )}
            </div>
        ...
        <div className="bp-map-actions" style={{ display: "flex", gap: 16, flexWrap: "wrap", marginTop: 20, justifyContent: "center" }}>
          ...
          {addressStatus === "error" && (
            <div style={{ fontSize: 13, color: "#ef4444" }}>
              Address not found. Try refining it.
            </div>
          )}
          {status === "denied" && (
            <div style={{ fontSize: 13, color: "#94a3b8" }}>
              Geolocation unavailable — showing city center
            </div>
          )}
        </div>
        ...
        <div style={{ display: "flex", gap: 24, flexWrap: "wrap", marginTop: 16, justifyContent: "center" }}>
          {[
            { color: "#ef4444", label: "Risk / Price threat" },
            { color: "#f59e0b", label: "New competitor review" },
            { color: "#22c55e", label: "Market trend / Opportunity" },
          ].map((leg) => (
...
const STEPS = [
  {
    ...
    label: "How it works?",
    title: "Monitoring",
    body: "The data‑search agent methodically scans the location and identifies competitors, customer traffic, reviews and ratings, socio‑demographic parameters, and regulatory context.",
    highlight: "Result — a factual market picture around your location",
  },
  {
    id: "data",
    icon: "🗂️",
    ...
    title: "5 minutes",
    body: "Specify your product, key specifics, target audience, and location — that’s enough to launch personal monitoring.",
    highlight: "No access to accounting systems or sensitive data",
  },
  {
    id: "result",
    icon: "📬",
    ...
    title: "Control",
    body: "Receive monitoring results for your niche plus tax and regulatory updates via email or Telegram weekly or daily.",
    highlight: "Clear updates instead of chaos and overload",
  },
];
  ...
  return (
    <section id="how-it-works" style={{ background: "#f0f7ff", padding: "72px 0" }}>
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <h2 style={{ fontSize: "clamp(1.6rem,3vw,2.3rem)" }}>
            3 steps to control your market.
            <span style={{ color: "#0683f5" }}>
              {" "}
              Your daily digital department for market monitoring and business protection.
            </span>
          </h2>
        </div>
...
const FREQ_LABELS: Record<number, string> = {
  1: "Real-time", 2: "Every 2h", 3: "Daily", 4: "Weekly", 5: "Low-frequency",
};
...
const NOTIFS = [
  { type: "danger", icon: "🔴", text: "Competitor dropped prices — time to act!", time: "right now" },
  { type: "warn",   icon: "🟡", text: "New 5★ review for Coffee‑House — check it.", time: "10 min ago" },
  { type: "ok",     icon: "🟢", text: "Delivery demand grew by 18% this week.", time: "1 h ago" },
  { type: "ok",     icon: "🟢", text: "Your rating is up to 4.7 — top in the area!", time: "3 h ago" },
];
      ...
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          <h2 style={{ fontSize: "clamp(1.6rem,3vw,2.3rem)" }}>
            ...
            <span style={{ color: "#0683f5" }}>
              {" "}
              Configure how and where analytics arrive — everything at hand.
            </span>
          </h2>
        </div>
          ...
          <div style={{ flex: "1 1 300px" }}>
            <div style={{ marginBottom: 36 }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, color: "#94a3b8" }}>
                <span>Real-time</span><span>Low-frequency</span>
              </div>
            </div>
            ...
            <div style={{
              ...
              <strong style={{ color: "#0683f5" }}>Tip:</strong> For small businesses, the best
              setup is Telegram + Daily. Average reaction time is 4 minutes.
            </div>
          </div>
      ...
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 12 }}>
          <h2 style={{ fontSize: "clamp(1.6rem,3vw,2.3rem)" }}>
            ...
            <span style={{ color: "#0683f5" }}>
              {" "}
              Listen to the morning briefing on your way to work.
            </span>
          </h2>
        </div>
        ...
        <div style={{ maxWidth: 600, margin: "40px auto 0", textAlign: "center" }}>
          <div style={{
            ...
            <p style={{ marginTop: 14, fontSize: 13, color: "#94a3b8" }}>
              Or hover the waveform for a preview
            </p>
          </div>
        </div>
      </div>
...
const BP_FEATURES = [
  ...
  "Push alerts in Telegram / WhatsApp",
  "Price & promo radar in your area",
  "Real‑time review tracking",
  "Voice briefings every morning",
];

const MR_FEATURES = [
  "TAM / SAM / SOM market sizing",
  "Competitor profiles and benchmarks",
  "Financial model with ROI forecast",
  "PDF / DOCX report with sources",
  "Niche and entry‑point analysis",
];
      ...
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          <p style={{ color: "#64748b", fontSize: 16, marginTop: 10 }}>
            Two products for different tasks. You can use both.
          </p>
        </div>
        ...
        <div style={{ display: "flex", gap: 28, flexWrap: "wrap", justifyContent: "center" }}>
          <motion.div
            ...
            <h3 style={{ fontSize: 22, fontWeight: 800, marginBottom: 8 }}>Business Immunity</h3>
            <p style={{ fontSize: 15, opacity: 0.85, lineHeight: 1.7, marginBottom: 28 }}>
              For teams already operating and protecting market share from competitors.
            </p>
          ...
          <motion.div
            ...
            <h3 style={{ fontSize: 22, fontWeight: 800, color: "#1e6078", marginBottom: 8 }}>Strategic Shield</h3>
            <p style={{ fontSize: 15, color: "#64748b", lineHeight: 1.7, marginBottom: 28 }}>
              For launching new products, capturing new niches, and data‑driven strategic decisions.
            </p>
            <ul style={{ listStyle: "none", padding: 0, margin: "0 0 32px", display: "flex", flexDirection: "column", gap: 10 }}>
              {MR_FEATURES.map((f) => (
            ...
            <a href="/solutions/marketResearch" style={{
              display: "block", textAlign: "center", padding: "13px 0", borderRadius: 12,
...
function BpBetaForm() {
  ...
  return (
    <form onSubmit={onSubmit} style={{ maxWidth: 420, margin: "0 auto", textAlign: "left" }}>
      <div className="mb-3">
        <label htmlFor="beta-email-bp-en" className="form-label small fw-semibold text-secondary">Email</label>
        <input
          id="beta-email-bp-en"
          type="email"
      ...
      <div className="form-check mb-3">
        <input
          ...
          type="checkbox"
          id="beta-policy-bp-en"
          checked={isChecked}
          onChange={() => setIsChecked(!isChecked)}
        />
        <label className="form-check-label" htmlFor="beta-policy-bp-en">
    ...
    <section style={{
      ...
      <div className="container">
        ...
        <h2 style={{ fontSize: "clamp(1.8rem,4vw,2.8rem)", fontWeight: 800, color: "#1e6078", marginBottom: 16 }}>
          Try Business Pulse for free
        </h2>
        <p style={{ color: "#64748b", fontSize: 17, maxWidth: 520, margin: "0 auto 40px", lineHeight: 1.7 }}>
          3 months of free access for early beta users. No card required.
        </p>
        ...
        <div style={{ marginTop: "3rem", textAlign: "left", maxWidth: "36rem", margin: "3rem auto 0" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem" }}>
            {[
              ...
              { label: "MarketSense AI — market research", href: "/solutions/marketResearch" },
