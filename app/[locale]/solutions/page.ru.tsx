...
export default function SolutionsPage() {
  ...
  const solutions = [
    ...
    {
      title: "Экспертные продукты",
      description:
        "Персонализированные решения от нашей команды: бизнес-планы, исследования рынка и финансовые модели под ваш бизнес. Основано на 15+ годах практики и 230+ выполненных проектах.",
    ...
    <div style={{ backgroundColor: "#f8f9fa", minHeight: "100vh" }}>
      ...
      <main className="container py-5">
        <h1 className="mb-4" style={{ color: "#1e6078" }}>
          ИИ-инструменты валидации стартапа
        </h1>
        <p style={{ color: "#0785f6", fontSize: "1.1rem" }}>
          Upgrowplan объединяет ИИ-инструменты для валидации стартапов,
          исследования рынка, финансового моделирования, бизнес-планов и
          подготовки материалов для инвесторов.
        </p>
